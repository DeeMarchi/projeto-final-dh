 ...
 function roteiroCampo() {
     let opcoes = document.getElementsByClassName('option-coin')
     ...
     if (dia <= 30) {
         ...
         /*     moedaViagem.forEach(element => {
    moedas.push(`<option value=${element.id}>${element.simbolo}</option>`)
